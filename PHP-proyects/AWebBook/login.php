...
//esto es para que cuando se meta en index y no este logueado lo muestre
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST["logout"]) && isset($_POST["username"])) {
    ...
    foreach ($usuarios as $user) {
        ...
        if ($username == $user['nombre_usuario'] || $username == $user['email'] && password_verify($password, $user['contraseña'])) {
...
} else if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["logout"])) {// cuando cierra sesion la contraseña se pondra de nuevo 
